...
async def get_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("pyaesonemusic/assets/assets/font2.ttf", 30)
        font = ImageFont.truetype("pyaesonemusic/assets/assets/font.ttf", 30)
        title_font = ImageFont.truetype("pyaesonemusic/assets/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("pyaesonemusic/assets/assets/play_icons.png")
