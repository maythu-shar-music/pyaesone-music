...
from pyaesonemusic.utils import help_pannel
from pyaesonemusic.utils.database import get_lang
from pyaesonemusic.utils.decorators.language import LanguageStart, languageCB
from pyaesonemusic.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, START_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers
from pyaesonemusic.utils.stuffs.buttons import BUTTONS
from pyaesonemusic.utils.stuffs.helper import Helper
...
async def helper_private(
    ...
    if is_callback:
        ...
        await update.reply_photo(
            photo="https://files.catbox.moe/3ch25z.jpg",
