...
from pyaesonemusic.utils import get_readable_time
...
from pyaesonemusic.utils.decorators.language import language
from pyaesonemusic.utils.extraction import extract_user
from config import BANNED_USERS


@Client.on_message(filters.command(["gban", "globalban"]) & SUDOERS)
@language
...
@Client.on_message(filters.command(["ungban"]) & SUDOERS)
@language
...
@Client.on_message(filters.command(["gbannedusers", "gbanlist"]) & SUDOERS)
@language
